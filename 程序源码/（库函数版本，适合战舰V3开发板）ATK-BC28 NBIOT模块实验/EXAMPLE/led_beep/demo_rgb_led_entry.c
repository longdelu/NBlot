        ...
        {                                                       
            ...
            {   
                ...
                case RGB_LED_YELLOW:              
                    ...
                    //发送数据iot平台 01代表RGBLED处于开启状态； 02代表是黄色          
                    nbiot_ncdp_send_hexstr(nbiot_handle, strlen("0102"), "0102", NBIOT_NCDP, NULL); 
                
                    break;
                
                 case RGB_LED_PURPLE:              
              
                    //发送数据iot平台 01代表RGBLED处于开启状态； 03代表是紫色          
                    nbiot_ncdp_send_hexstr(nbiot_handle, strlen("0103"), "0103", NBIOT_NCDP, NULL); 
                
                    break; 

                 case RGB_LED_PINK:              
              
                    //发送数据iot平台 01代表RGBLED处于开启状态； 04代表是粉色          
                    nbiot_ncdp_send_hexstr(nbiot_handle, strlen("0104"), "0104", NBIOT_NCDP, NULL); 
            ...
            {              
                //发送数据iot平台 00代表RGBLED处于关闭状态； 00代表是关闭了，没有颜色         
                nbiot_ncdp_send_hexstr(nbiot_handle, strlen("0000"), "0000", NBIOT_NCDP, NULL);               
            }              
