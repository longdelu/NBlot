...
{    
    ...
    //中断线2-PH2
    HAL_NVIC_SetPriority(EXTI2_IRQn,12,1);       //抢占优先级为12，子优先级为1
    HAL_NVIC_EnableIRQ(EXTI2_IRQn);              //使能中断线2
    
    //中断线3-PH3
    HAL_NVIC_SetPriority(EXTI3_IRQn,12,2);       //抢占优先级为12，子优先级为2
    HAL_NVIC_EnableIRQ(EXTI3_IRQn);              //使能中断线2
    
    //中断线13-PC13
    HAL_NVIC_SetPriority(EXTI15_10_IRQn,12,3);   //抢占优先级为12，子优先级为3
