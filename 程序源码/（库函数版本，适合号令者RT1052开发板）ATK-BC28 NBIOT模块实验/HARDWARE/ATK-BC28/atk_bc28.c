...
static void __nbiot_plfm_init (void)
{
    ...
    GPIO_PinWrite(g_nbiot_dev_info.GPIO_RST, g_nbiot_dev_info.rst_pin, 1);    //RST置1    
...
void nbiot_lowpower_set (nbiot_handle_t nbiot_handle, int en)
{
    ...
    GPIO_PinWrite(nbiot_handle->p_dev_info->GPIO_VEN, nbiot_handle->p_dev_info->ven_pin, en);
}
...
void nbiot_rst_set (nbiot_handle_t nbiot_handle, int en)
{
    ...
    GPIO_PinWrite(nbiot_handle->p_dev_info->GPIO_RST, nbiot_handle->p_dev_info->rst_pin, en);
}
