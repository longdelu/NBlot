...
{ 
    ...
    {
        LPSPI3_ReadWriteByte((u8)((ReadAddr)>>24));    
    }
    LPSPI3_ReadWriteByte((u8)((ReadAddr)>>16));   //发送24bit地址    
    LPSPI3_ReadWriteByte((u8)((ReadAddr)>>8));   
    LPSPI3_ReadWriteByte((u8)ReadAddr);   
...
void W25QXX_Write_Page(u8* pBuffer,u32 WriteAddr,u16 NumByteToWrite)
{
    ...
    if(W25QXX_TYPE==W25Q256)                    //如果是W25Q256的话地址为4字节的，要发送最高8位
    {
        LPSPI3_ReadWriteByte((u8)((WriteAddr)>>24)); 
    }
    LPSPI3_ReadWriteByte((u8)((WriteAddr)>>16)); //发送24bit地址    
    LPSPI3_ReadWriteByte((u8)((WriteAddr)>>8));   
...
{  
    ...
    if(W25QXX_TYPE==W25Q256)                    //如果是W25Q256的话地址为4字节的，要发送最高8位
    {
        LPSPI3_ReadWriteByte((u8)((Dst_Addr)>>24)); 
    }
    LPSPI3_ReadWriteByte((u8)((Dst_Addr)>>16));  //发送24bit地址    
    LPSPI3_ReadWriteByte((u8)((Dst_Addr)>>8));   
    LPSPI3_ReadWriteByte((u8)Dst_Addr);         
    W25QXX_CS(1);                               //取消片选    
